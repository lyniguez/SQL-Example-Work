...
-- 1b) display first and last name in a single column of all actors in upper case letters
...
-- 2c) actors whose last names contain the letters LI. This time, order the rows by last name and first name, in that order
select first_name, last_name
from actor
...
-- 4c) fix The actor HARPO WILLIAMS was accidentally entered in the actor table as GROUCHO WILLIAMS
select first_name, last_name
from actor
